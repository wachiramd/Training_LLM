...
if __name__ == "__main__":
    ...
    print("Initializing model with DeepSeekMLAttention, SwiGLU FFN, and Post-LN LayerNorm")
    print(f"Query Compression Dim: {q_comp_dim}, KV Compression Dim: {kv_comp_dim}")
